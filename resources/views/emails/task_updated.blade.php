        ...
        <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse; margin-top:10px;">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border:1px solid #ddd; padding:8px;">{{ $task->assignment_datetime?->format('M d, Y h:i A') ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td style="border:1px solid #ddd; background:#e0e7ff; font-weight:bold;">Resource Allocation Deadline</td>
                    <td style="border:1px solid #ddd; padding:8px; color:#dc2626; font-weight:bold;">{{ $task->deadline_datetime?->format('M d, Y h:i A') ?? 'N/A' }}</td>
                </tr>
                <tr>
