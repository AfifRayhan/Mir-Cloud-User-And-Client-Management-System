...
<x-app-layout>
    ...
    @push('scripts')
    <div id="billing-task-management-config" class="d-none"
        data-base-url="/billing-task-management">
    </div>
    @vite(['resources/views/task-management/billing-task-management.js'])
    @endpush
</x-app-layout>